...
class PuitController extends \TCG\Voyager\Http\Controllers\VoyagerBaseController
{
    ...
    public function destroy(Request $request, $id)
    {
        ...
        foreach ($ids as $id) {
           ...
           $chaine=$ch[1];
            ...
            $Fracturation=Fracturation::where('puit_id',$id)->first();
