...
<style>
    ...
    <table id="customers">
      ...
      <tr>
        ...
        {{-- <td>{{$item ['Statut']}}</td> --}}
        @if ($routeName=='fiche.index')
        <td><a class="btn btn-sm btn-danger center  " style="width: 30%;background-color: rgb(0, 0, 0)" href=" {{route('fiche.detaille',['id'=>$item ['contrat_id']])}} ">consulter la fiche</a></td>
        @endif
        @if($routeName=='renseignement')
        ...
        @endif
        @if($routeName=='FicheRealisation')
        <td><a class="btn btn-sm btn-danger center " style="width: 30%;background-color: rgb(0, 0, 0)" href=" {{route('detailleFicheRealisation',['id'=>$item ['contrat_id']])}} ">consulter la fiche</a></td>
        @endif
        @if ($routeName=='FicheFinance')
        <td><a class="btn btn-sm btn-danger center " style="width: 30%;background-color: rgb(0, 0, 0)" href=" {{route('detailleFicheFinance',['id'=>$item ['contrat_id']])}} ">consulter la fiche</a></td>
        @endif
        @if ($routeName=='statistique')
        <td><a class="btn btn-sm btn-danger center " style="width: 30%;background-color: rgb(0, 0, 0)" href=" {{route('PuitParmois',['id'=>$item ['contrat_id']])}} ">Statistique</a></td>
        @endif
      </tr>
      @endforeach
