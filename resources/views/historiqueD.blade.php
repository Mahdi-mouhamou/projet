...
<h2 style="margin-bottom: 40px;;color: black;text-align:center;font-family:fangsong">historique des suppression  </h2>
...
<table  id="customers" style="width:100%">
   ...
   <td> <a  href=" {{ route('showDataD',['id'=>$item->id,'model'=>$item->model])}} ">Voir data</a></td>
@endforeach
    </tr>
</table>  
@endsection